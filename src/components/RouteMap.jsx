  ...
  return (
    <div className="bg-[#12172b] rounded-3xl border border-[#1e2642] overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="relative">
        ...
        {/* Map Legend */}
        <div className="absolute bottom-3 right-3 bg-[#0b0e1b]/90 backdrop-blur-md px-3 py-2 rounded-2xl text-[11px] shadow-lg border border-[#1e2642] flex flex-col gap-1 z-20 pointer-events-none text-slate-200">
      ...
      <div className="p-4 bg-[#0b0e1b] border-t border-[#1e2642] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
        <div className="flex items-center gap-2">
          <button
            onClick={() => speakText(activeStep.instruction)}
            className="px-3.5 py-2 bg-[#182038] hover:bg-[#242e50] border border-[#242e50] rounded-xl font-bold text-white flex items-center gap-1.5 shadow-sm transition-all"
          >
